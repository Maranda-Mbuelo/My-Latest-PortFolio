...
export class OffersComponent {
  ...
  languages: string[] = [
    'C++', 'C#', 'Python', 'SQL', 'Typescript', 'JavaScript', 'HTML', 'CSS',
    'Tailwind Css', 'Bootstrap','Angular', 'Ionic', 'ASP.NET', 'Angular Material'
  ];
  services: { name: string, percentage: number }[] = [
    ...
    { name: 'mobile app development and expert instruction', percentage: 50 }
  ];
